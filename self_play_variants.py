...
import jax
from train_agent import train_normal, train_frozen, train_vs_all
...
if __name__ == "__main__":
    ...
    # # Test Training vs All Previous Models
    ...
    #     num_self_plays_per_iteration=NUM_SELF_PLAYS_PER_ITERATION,
    #     learning_rate=LEARNING_RATE,
    #     ckpt_filename=f"{BASE_PATH}/vs_all_agent.ckpt",
    #     random_seed=RANDOM_SEED,
    #     weight_decay=WEIGHT_DECAY,
    #     lr_decay_steps=LR_DECAY_STEPS,
    #     num_eval_games=NUM_EVAL_GAMES,
...
# run_train_vs_other.py
import jax
from train_agent import train_play_vs_other

if __name__ == "__main__":
    # Common parameters
    GAME_CLASS = "games.connect_four_game.Connect4Game"
    AGENT_CLASS = "policies.resnet_policy.ResnetPolicyValueNet"
    BASE_PATH = "./models_test_vs_other"
    RANDOM_SEED = 42
    ...
    # Use the previously trained agent as the other agent
    OTHER_CKPT_FILENAME = "./agent.ckpt"  # Path to the checkpoint of the other (frozen) agent
    ...
    train_play_vs_other(
        ...
        num_self_plays_per_iteration=NUM_SELF_PLAYS_PER_ITERATION,
        learning_rate=LEARNING_RATE,
        ckpt_filename=f"{BASE_PATH}/play_vs_other_agent.ckpt",
        other_ckpt_filename=OTHER_CKPT_FILENAME,
        random_seed=RANDOM_SEED,
        weight_decay=WEIGHT_DECAY,
        lr_decay_steps=LR_DECAY_STEPS,
        num_eval_games=NUM_EVAL_GAMES,
